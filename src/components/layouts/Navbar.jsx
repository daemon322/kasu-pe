                ...
                {results.slice(0, 5).map(product => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-slate-500">{product.subcat ?? product.category}</p>
                    </div>
      ...
      <nav className={`nb-font sticky top-0 z-50 transition-all duration-300
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-5 flex items-center h-14 sm:h-16 gap-2 sm:gap-3">
          ...
          <button
            ...
            className="md:hidden flex flex-col justify-center items-center w-10 h-10 rounded-xl hover:bg-slate-800 active:bg-slate-700 transition-all flex-shrink-0 gap-[5px]"
          >
            <span className="block w-5 h-[2px] bg-white rounded-full" />
            <span className="block w-5 h-[2px] bg-white rounded-full" />
            <span className="block w-3.5 h-[2px] bg-white rounded-full self-start" />
          </button>
